        ...
        users.forEach(u => {
            ...
            if (diffDays <= 30 && u.role === 'student') {
                notifs.push({
                    ...
                    message: `สมัครสมาชิกใหม่: ${u.displayName || u.email}`,
                    note: `เมื่อ ${createdAt.toLocaleDateString('th-TH')}`,
                    date: createdAt
                });
            }
                ...
                u.registeredCourses.forEach((c, idx) => {
                    ...
                    if (diffDaysExpiry < 0 && diffDaysExpiry > -30) {
                        notifs.push({
                            id: `exp-${u._id}-${idx}`,
                            type: 'course_expired',
                            message: `คอร์สหมดอายุ: ${c.subject} (${u.displayName})`,
                        ...
                        notifs.push({
                            ...
                            message: `คอร์สกำลังจะหมดอายุ: ${c.subject} (${u.displayName})`,
                        ...
                        c.extensionHistory.forEach((ext, extIdx) => {
                            ...
                            if (diffDaysExt <= 30) {
                                notifs.push({
                                    ...
                                    message: `มีการต่ออายุคอร์ส: ${c.subject} (${u.displayName})`,
                    ...
                    if (c.totalSessions !== undefined && c.totalSessions > 0 && (c.usedSessions || 0) >= c.totalSessions) {
                        notifs.push({
                            ...
                            message: `โควต้าหมด: ${c.subject} (${u.displayName})`,
