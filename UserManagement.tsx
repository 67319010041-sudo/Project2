...
import {
    Search, Users, Trash2, Eye, Calendar
} from 'lucide-react';
            ...
            <Card className="dark:bg-slate-800 dark:border-slate-700 shadow-sm rounded-none">
                <CardHeader>
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            <CardTitle className="dark:text-white text-xl">ระบบจัดการครู (Teacher Management)</CardTitle>
                ...
                <Dialog open={!!selectedUser} onOpenChange={(open) => !open && setSelectedUser(null)}>
                    <DialogContent className="max-w-md rounded-none">
                        <DialogHeader>
                            <DialogTitle>ข้อมูลผู้ใช้ (User Details)</DialogTitle>
                        </DialogHeader>
                        {selectedUser && (
                                ...
                                <div className="space-y-4 border-t pt-4 dark:border-slate-700">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium dark:text-white">
                                            {selectedUser.createdAt ? formatThaiDate(selectedUser.createdAt) : 'Unknown'}
                                        </p>
                                    </div>
                                </div>
