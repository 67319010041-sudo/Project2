    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-slate-800">ระบบเช็คชื่อ (Attendance System)</h2>
                        ...
                        <div className="flex flex-wrap gap-3 items-center">
                            ...
                            <Select value={selectedSubject} onValueChange={setSelectedSubject}>
                                <SelectTrigger className="w-[200px] rounded-none border-slate-200">
                                    <SelectValue placeholder="เลือกวิชา (Subject)" />
                                </SelectTrigger>
                        ...
                        <Table>
                            <TableHeader className="bg-slate-50">
                                <TableRow>
                                    ...
                                    <TableHead className="text-center">เข้าเรียน (Present)</TableHead>
                                    <TableHead className="text-center">สาย (Late)</TableHead>
                                    <TableHead className="text-center">ลา (Leave)</TableHead>
                                    <TableHead className="text-center">ขาด (Absent)</TableHead>
                                    ...
                                    return (
                                        <TableRow key={record._id} className="hover:bg-slate-50/50">
                                            ...
                                            <TableCell>
                                                ...
                                                <div className="text-xs text-slate-500">Teacher ID: {record.teacherId?.substring(0, 6)}...</div>
                                            </TableCell>
                                            <TableCell>
