                                ...
                                <TabsContent value="privacy" className="mt-0 space-y-4">
                                    <div className="prose dark:prose-invert max-w-none text-sm">
                                        ...
                                        <ul className="list-disc pl-5 space-y-1">
                                            <li><strong>ข้อมูลระบุตัวตน:</strong> ชื่อ-นามสกุล, ชื่อเล่น, ระดับชั้นที่เรียน</li>
                                            <li><strong>ข้อมูลการติดต่อ:</strong> เบอร์โทรศัพท์, อีเมล, Line ID</li>
                                            <li><strong>ข้อมูลการศึกษา:</strong> ประวัติการเรียน, คะแนนสอบ, การบ้าน</li>
                                            <li><strong>ข้อมูลทางเทคนิค:</strong> IP Address, Cookies, Log Files</li>
                                        </ul>

                                        <h3 className="font-bold text-lg mt-4 mb-2">3. วัตถุประสงค์การใช้ข้อมูล</h3>
                                        <p>เราใช้ข้อมูลเพื่อให้บริการระบบการเรียน, รายงานผลผู้ปกครอง, และปรับปรุงประสิทธิภาพระบบ</p>
