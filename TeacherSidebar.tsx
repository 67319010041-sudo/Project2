...
import { Users, FileText, Settings, ShieldCheck, UserCog, LogOut, CalendarCheck, Bell, Award, UserPlus, GraduationCap, BookOpen, List } from "lucide-react";
...
export default function TeacherSidebar({ activeTab, onTabChange }: TeacherSidebarProps) {
    ...
    const menuGroups = [
        ...
        },
        {
            ...
            items: [
                { id: 'schedule', label: 'ตารางสอน/รายชื่อนักเรียน', icon: List },
            ]
        }
    ];
